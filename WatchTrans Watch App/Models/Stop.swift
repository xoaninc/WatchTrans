...
struct Stop: Identifiable, Equatable, Hashable {
    ...
    func hasCorrespondence(excludingLine currentLine: String) -> Bool {
        ...
        return !metroLines.isEmpty || !mlLines.isEmpty || !trenLines.isEmpty || !tramLines.isEmpty || (corFunicular != nil && !corFunicular!.isEmpty) || (corBus != nil && !corBus!.isEmpty) || correspondences != nil
    }
